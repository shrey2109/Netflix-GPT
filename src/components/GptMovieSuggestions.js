...
const GptMovieSuggestions = () => {
  ...
  return (
    <div className="m-10 px-12 bg-black rounded-3xl bg-opacity-50">
      <SuggestedMovie />
      {MOVIE_GENRE_LIST.genres.map((genre) => (
        <button
          ...
          className="m-5 p-4 w-56 h-16 rounded-lg border-[2.5px] border-purple-300 text-purple-500 font-semibold text-lg bg-opacity-30"
